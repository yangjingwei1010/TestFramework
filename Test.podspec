...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "juswill" => "juswill.yang@100tal.com" }
  # Or just: spec.author    = "juswill"
  # spec.authors            = { "juswill" => "juswill.yang@100tal.com" }
  # spec.social_media_url   = "https://twitter.com/juswill"
